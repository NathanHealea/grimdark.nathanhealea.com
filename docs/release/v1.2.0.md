...
# ✨ New Features
**User Profile Management**: Users are now able to update information in there profile, update profile images, and manage armies associated wit there user.

**Tickets:**
* [A user directory is created in the profile-pictures bucket when a user is created. #14
](https://github.com/NathanHealea/grimdark.nathanhealea.com/issues/14)
* 
...
1. Run sql procuestions to build up new Public Profile Picture bucket.
...
# 🚧 Known Issues
[Known Issue 1]: [Brief description of the issue and its potential impact. If a workaround exists, provide it.]

Workaround: [Describe how users can mitigate the issue.]
